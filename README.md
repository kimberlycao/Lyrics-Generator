...
<img alt="GRU Model Forward Pass" src="images/GRU_Model.png" width="450"/>
...
**Method (2):** No data augmentation was performed for the GPT-2 model because it produced decent lyrics after being trained on the small dataset and even after expanding the dataset with larger Spotify playlists, the results were not significantly better.
